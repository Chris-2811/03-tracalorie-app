class CalorieTracker {
  ...
  loadItems() {
    this._meals.forEach(meal => {
      return this._displayNewMeal(meal)
    })

    this._workouts.forEach(workout => {
      return this._displayNewWorkout(workout)
    })
  }
  ...
  _displayNewMeal(meal) {
    ...
    document.getElementById('meal-items').appendChild(div);
  }
  ...
  _displayNewWorkout(workout) {
    ...
    document.getElementById('workout-items').appendChild(div);
  }
...
class Storage {
  static getCalorieLimit(defaultLimit = 2000) {
    ...
    console.log(+localStorage.getItem('calorieLimit'))
